...
void tracelog_regmem(UINT64 insAddr, std::string const& insDis, REG reg, UINT64 val1, ADDRINT addr, INT64 val2, UINT32 size);
...
void tracelog_mem(UINT64 insAddr, std::string const& insDis, ADDRINT addr, INT64 val,UINT32 size);
void tracelog_memimm(UINT64 insAddr, std::string const& insDis, ADDRINT addr, INT64 val, UINT64 imm, UINT32 size);
void tracelog_memreg(UINT64 insAddr, std::string const& insDis, ADDRINT addr, INT64 val1, REG reg, UINT64 val2, UINT32 size);
void tracelog_memmem(UINT64 insAddr, std::string const& insDis, ADDRINT addr1, INT64 val1, ADDRINT addr2, INT64 val2, UINT32 size);
